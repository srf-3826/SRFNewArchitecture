...
*/
  ...
  public void robotPeriodic() {
    // Update GyroIO StatusSignals, and compute max motion estimateds
    // Also, poll mode sensitive UI inputs, and handle helper start, stop, and life cycle updates
    // Be sure to do this before the ComandScheduler runs
    m_robotContainer.update();

    // Now run the Scheduler.  This is responsible for polling buttons, adding newly-scheduled
