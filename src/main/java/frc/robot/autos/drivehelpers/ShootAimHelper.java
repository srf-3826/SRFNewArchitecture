...
public class ShootAimHelper implements ContinuousAction {
    ...
    public void update() {
        ...
        // TODO: compare the ID to the hub AprilTag IDs for our alliance color, make sure we're using
        // nearest target info that matches one of these Hub ID's
        var info = opt.get();
    ...
    public boolean isFinished() {
        boolean b = (m_ctx.inShootMode() && m_ctx.isShootAutoDriveEnabled()) ? false : true;
        return b;
    }
